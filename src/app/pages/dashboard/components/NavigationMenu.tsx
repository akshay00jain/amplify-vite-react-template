      ...
      <CardBody className="pb-2">
        ...
        <div className="hstack gap-3 text-center justify-content-evenly">
          <div>
            ...
            <small>{labels.contacts.titlePlural}</small>
          </div>
          <div>
            <h5 className="mb-0">113</h5>
            <small>{labels.activities.titlePlural}</small>
          </div>
          <div>
            <h5 className="mb-0">7</h5>
            <small>{labels.contacts.favorites.title}</small>
          </div>
        </div>
        <hr />
...
const NavigationMenu = ({ open, toggle }: OffcanvasControlType) => {
